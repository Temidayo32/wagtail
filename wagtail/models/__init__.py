...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def save(self, clean=True, user=None, log_action=False, **kwargs):
        ...
        New pages should generally be saved via the `add_child() <https://django-treebeard.readthedocs.io/en/latest/api.html#treebeard.models.Node.add_child>`_ or `add_sibling() <https://django-treebeard.readthedocs.io/en/latest/api.html#treebeard.models.Node.add_sibling>`_
